...
<body>
    ...
    <section class="home">
        <div class="page-title-container">
            <div class="page-title-text"> <i class='bx bx-fork icon page-title-icon'></i> <span>Recipes</span> </div>
        </div>
        ...
        <div class="search-filter-container">
            ...
            <div class="InputContainer search-input-container">
                <input type="text" class="input" id="searchStockName" placeholder="Search recipe" />
