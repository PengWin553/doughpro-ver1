                    ...
                    <!-- <form id="newCategoryForm"> 
                        ...
                        <form class="form_container_inp" style="width: 100%; padding: 0;" id="newUserForm">
                            ...
                            <div class="input_container_inp">
                                ...
                                <input placeholder="username" title="Inpit title" name="add_username" type="text" class="input_field_inp" id="add_username" autocomplete="off">
                            </div>
                            <!-- role -->
                            <div class="input_container_inp">
                                ...
                                <select title="Input title" name="add_role" class="input_field_inp" id="add_role" autocomplete="off">
                            ...
                            <div class="input_container_inp">
                                ...
                                <input placeholder="name@gmail.com" title="Inpit title" name="add_email" type="text" class="input_field_inp" id="add_email" autocomplete="off">
                            </div>
                            <!-- password -->
                            <div class="input_container_inp">
                                <label class="input_label_inp" for="password_field">password</label>
                                <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon_inp">
                                ...
                                <input placeholder="Password" title="Inpit title" name="add_password" type="password" class="input_field_inp" id="add_password" autocomplete="off">
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form_container_inp" style="width: 100%; padding: 0;" id="updateUserForm">
                            ...
                            <div class="input_container_inp">
                                ...
                                <input id="update_username" placeholder="username" title="Inpit title" name="update_username" type="text" class="input_field_inp" id="add_username" autocomplete="off">
                            </div>
                            <!-- role -->
                            <div class="input_container_inp">
                                <label class="input_label_inp" for="role_field">Role</label>
