...
<body>
    ...
    <section class="home">
        <div class="page-title-container">
            <div class="page-title-text"> <i class='bx bx-category-alt icon page-title-icon'></i> <span>Logs</span> </div>
        </div>
        ...
        <div class="search-filter-container">
            ...
            <div class="InputContainer search-input-container">
                <input type="text" class="input" id="searchInput" placeholder="Search user" oninput="liveSearch()">
