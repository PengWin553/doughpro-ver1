...
<body>
    ...
    <main class="login-form-container_inp">
        ...
        <form class="form_container_inp login-form_inp">
            ...
            <div class="title_container_inp">
                <p class="title_inp">Login to your account</p>
                <span class="subtitle_inp">Welcome to DoughPro, your smart bakery inventory manager. </span>
            </div>
            <div class="input_container_inp">
                ...
                <input placeholder="name@gmail.com" title="enter email" name="login-email" type="text" class="input_field_inp" id="login-email" autocomplete="off">
            </div>
            <div class="input_container_inp">
                ...
                <input placeholder="Password" title="enter password" name="login-password" type="password" class="input_field_inp" id="login-password" autocomplete="off">
            </div>
            <button title="Sign In" type="submit" class="sign-in_btn_inp" id="btn-login">
                <span>Sign In</span>
            </button>

            <div class="separator_inp">
                <hr class="line_inp">
                <hr class="line_inp">
            </div>
            <p class="note_inp">Terms of use &amp; Conditions</p>
        </form>
    </main>
