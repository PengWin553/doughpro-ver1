    ...
    <main class="login-form-container">
        ...
        <form class="form_container">
            ...
            <div class="title_container">
                ...
                <span class="subtitle">Welcome to DoughPro, your smart bakery inventory manager. </span>
            </div>
            <div class="input_container">
                ...
                <input placeholder="name@gmail.com" title="Inpit title" name="login-email" type="text" class="input_field" id="login-email" autocomplete="off">
            </div>
            <div class="input_container">
                ...
                <input placeholder="Password" title="Inpit title" name="login-password" type="password" class="input_field" id="login-password" autocomplete="off">
            </div>
            <button title="Sign In" type="submit" class="sign-in_btn" id="btn-login">
                <span>Sign In</span>
            </button>
