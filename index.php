    ...
    <main class="login-form-container">
        ...
        <form class="form_container">
            ...
            <div class="input_container">
                ...
                <input placeholder="name@gmail.com" title="Inpit title" name="login-email" type="text" class="input_field" id="login-email">
            </div>
            <div class="input_container">
                ...
                <input placeholder="Password" title="Inpit title" name="login-password" type="password" class="input_field" id="login-password">
            </div>
