    ...
    <main class="login-form-container_inp">
        ...
        <form class="form_container_inp login-form_inp">
            ...
            <div class="input_container_inp">
                ...
                <input placeholder="name@gmail.com" title="Inpit title" name="login-email" type="text" class="input_field_inp" id="login-email" autocomplete="off">
            </div>
            <div class="input_container_inp">
                ...
                <input placeholder="Password" title="Inpit title" name="login-password" type="password" class="input_field_inp" id="login-password" autocomplete="off">
            </div>
